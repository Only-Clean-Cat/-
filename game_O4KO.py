...
cprint('Правила игры: Игрок играет против "ДИЛЕРА"(компьютера).\n '
       'Выигрывает тот кто набирает больше очков, НО, не более 21.\n'
       'Туз может считаться как 1 так и 11.', color='yellow')
cprint('НАЧИНАЕМ!', color='green')
